      ...
      <div className="w-10/12 mx-auto p-10 bg-linear-to-r from-[#3b2ce3] to-[#abacf8] text-base flex flex-col items-center justify-center text-center text-white rounded-xl">
        ...
        <div className="flex items-center gap-4 md:gap-8 mt-5">
          {user ? (
            <Link
              to="/addmodel"
              className="btn p-1 md:p-2 bg-primary text-white rounded-xl border-none shadow-md hover:shadow-white"
            >
              Post a Model
            </Link>
          ) : (
          ...
          <Link
            to="/allmodels"
            className="btn p-1 md:p-2 bg-surface text-accent rounded-xl border-none hover:shadow-xl"
          >
            Explore Models
          </Link>
        </div>
