...
const MyModels = () => {
    ...
    useEffect(()=>{
        fetch(`https://ai-model-inventory-backend.vercel.app/mymodels?email=${user?.email}`)
        .then(res=>res.json())
    ...
    const noMyModel = (
        <div className="h-[50vh] flex flex-col items-center justify-center">
          <h1 className="text-xl font-bold text-muted text-center">
            You haven't created any AI models yet. Start sharing now!
          </h1>
          <Link to="/addmodel" className="btn btn-primary text-white mt-4">
